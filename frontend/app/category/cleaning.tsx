...
const HERO_MEDIA: HeroMediaItem[] = [
  {
    ...
    caption: "Spotless home, every time",
  },
  {
    type: "image",
    uri: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=900&q=80",
    caption: "Deep cleaning experts",
  },
  {
    type: "image",
    uri: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=900&q=80",
    caption: "Bathroom shine",
  },
  {
    type: "image",
    uri: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=900&q=80",
    caption: "Sparkling kitchens",
  },
];
...
export default function CleaningCategoryScreen() {
  ...
  const cms = useCategoryCMS("cleaning-pest");
  ...
  const dynSubCategories = useMemo(() => {
    if (cms.sub_categories && cms.sub_categories.length > 0) {
      return cms.sub_categories.map((s) => ({
        id: s.slug || s.id,
        name: s.name,
        image: s.image_url || ((CLEANING_SUBCATEGORIES)[0] as any)?.image || "",
  ...
  const brandName = cms.category?.brand_name || cms.category?.name || "Cleaning";
  ...
  const promoLabel = promo?.label || "Get ₹300 off";
  const promoSubLabel = promo?.sub_label || "On orders above ₹1499";
    ...
    <SafeAreaView style={styles.root} edges={["top"]}>
      ...
      >
        ...
        <View style={styles.mainContent}>
          ...
          {/* Warranty Card */}
          <TouchableOpacity style={styles.warrantyCard} onPress={() => router.push("/cover/cleaning")}>
