...
export default function PlumberServiceScreen() {
  ...
  for (let i = 0; i < PLUMBER_CATEGORIES.length; i += 3) {
    rows.push(PLUMBER_CATEGORIES.slice(i, i + 3));
  }
  ...
  return (
    <SafeAreaView style={styles.root} edges={["top"]}>
      <ScrollView 
        ...
        bounces={false}
      >
        {/* Hero Banner - Light Blue background */}
          ...
          <View style={styles.titleSection}>
            <View style={styles.titleLeft}>
              ...
              <View style={styles.ratingRow}>
                ...
                <Text style={styles.ratingText}>4.77 (2.7 M bookings)</Text>
              </View>
            </View>
